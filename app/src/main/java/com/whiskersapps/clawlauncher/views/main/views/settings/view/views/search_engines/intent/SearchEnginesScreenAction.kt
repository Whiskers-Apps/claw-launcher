package com.whiskersapps.clawlauncher.views.main.views.settings.view.views.search_engines.intent
...
sealed class SearchEnginesScreenAction {
    ...
    data class UpdateAddEngineDialogFields(val name: String, val query: String) :
        SearchEnginesScreenAction()
    ...
    data class UpdateEditEngineDialogFields(
        val name: String,
        val query: String,
        val default: Boolean
    ) : SearchEnginesScreenAction()
